...
import dev.langchain4j.model.openai.OpenAiLanguageModel.OpenAiLanguageModelBuilder;
...
public class OpenAiLanguageModelFactory {
    ...
    /**
     * Creates OpenAiLanguageModelFactory.
     *
     * @param configuration the AI properties.
     */
    @Inject
    public OpenAiLanguageModelFactory(Configuration configuration) {
