...
public class OpenAiImageModelFactory {
    ...
    public OpenAiImageModel create() {
        ...
        configuration.getString("size").ifPresent(builder::size);
        configuration.getString("quality").ifPresent(builder::quality);
        configuration.getString("style").ifPresent(builder::style);
        ...
        configuration.getBoolean("with-persisting").ifPresent(builder::withPersisting);
        configuration.getString("persst-to").ifPresent(value -> builder.persistTo(Path.of(value)));
